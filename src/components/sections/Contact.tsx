    ...
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 sm:px-10 lg:px-16">
        <div className="max-w-3xl mx-auto text-center">
          ...
          {/* Label */}
          <span className="section-label-dark">Communauté</span>
          <div
          ...
          >
            Suivez nos{" "}
            <em style={{ fontStyle: "italic", color: "var(--rose-accent)" }}>créations</em>
          </h2>

          <p
            className="text-base leading-relaxed"
            style={{ color: "rgba(255,255,255,0.42)", maxWidth: "28rem", margin: "0 auto 3.5rem" }}
          >
            Retrouvez nos réalisations, inspirations et coulisses sur Instagram.
          </p>
            ...
            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-8">
              ...
              <div className="flex flex-col sm:flex-row gap-3 md:flex-col md:items-end">
                <a
                  ...
                  aria-label="Suivre @r.osesnails sur Instagram"
                >
